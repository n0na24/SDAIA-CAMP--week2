...
def main() -> None:
    ...
    # Optional: Task 3 outlier flag (if exists in your transforms module)
    try:
        from bootcamp_data.transforms import add_outlier_flag  # type: ignore
    except Exception:
        add_outlier_flag = None  # type: ignore
